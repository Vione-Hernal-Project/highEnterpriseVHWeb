...
export const SOLANA_MERCHANT_WALLET_ADDRESS =
  ...
  "";
export const SOLANA_RPC_URL = process.env.NEXT_PUBLIC_SOLANA_RPC_URL?.trim() || process.env.SOLANA_RPC_URL?.trim() || "";
export const SOLANA_NETWORK = process.env.NEXT_PUBLIC_SOLANA_NETWORK?.trim() || "";
...
export const USDC_SOLANA_MINT_ADDRESS = process.env.NEXT_PUBLIC_USDC_SOLANA_MINT?.trim() || "";
export const USDT_SOLANA_MINT_ADDRESS = process.env.NEXT_PUBLIC_USDT_SOLANA_MINT?.trim() || "";
